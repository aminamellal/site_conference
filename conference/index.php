...
<!-- banner -->
  ...
  <div id="about_conf" class="col-md-12" style="padding: 10px; margin-bottom: 20px;">
    <section>
        <h2 style="text-align: center; font-weight: bold;">"Conférence sur les Communications et Réseaux : Techniques d'Intelligence Artificielle pour les Réseaux Mobiles"</h2>
        <br>
        <br>
