...
<head>
	...
	<title>Administrateur - Supprimer membre</title>
			...
			<div class="content content-documentation">
				<div class="container-fluid">
					...
					<?php include 'main.php';
                        ?>
						<div class="card-body">
                            <h5 style="text-align:center;">Supprimer un membre</h5>
							<hr>
                            <?php
                                $sql = "SELECT * FROM ";
                                
                            ?>
                            <form class="row g-3 needs-validation" novalidate="" method="post" action="supprimer_membre.php">
